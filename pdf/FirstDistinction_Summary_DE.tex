...
\[
\lambda^3 \cdot \chi + \text{deg}^2 + \text{Korrektur} = 137{,}036...
\]
...
\medskip
\textit{Kein kausaler Zusammenhang bewiesen. Der "`Korrekturterm"' beinhaltet $V/(\text{deg} \cdot (E^2+1))$, was Post-hoc-Anpassung sein könnte.}
\end{beobachtung}
