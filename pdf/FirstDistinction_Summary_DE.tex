...
\subsection{Die unvermeidliche Erste Distinktion ($D_0$)}
...
\subsection{Speichersättigung und $K_4$-Emergenz}
...
\subsection{Der $K_4$-Laplace-Operator und Eigenwerte}
...
\subsection{Die Kopplungskonstante $\kappa = 8$}
...
\subsection{Die K$_4$-Verschränkungsidentität}
...
\subsection{Robustheit: Warum nicht K$_3$ oder K$_5$?}
