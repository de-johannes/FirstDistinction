...
Numerical outputs from K4 structure. These are **derived** from K₄ topology, then compared to observations as **consistency tests**.
...
**K₄ yields discrete integers (bare values). Observers measure continuum values (dressed by quantum loops).**
...
- All derived values within **1‰** of observations
...
- ✓ **Testable**: Formula extends to any new particle mass
...
**K₄ yields ΛCDM parameters from graph structure. Same method as α⁻¹, τ: bare integers + quantum corrections.**
...
Does K4 structure determine dark matter/energy ratios?
...
*All values derived from K₄ structure, compared to observations as consistency tests.*
